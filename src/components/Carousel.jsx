...
const Carousel = (props) => {
  ...
  const clickToSwipe = (direction) => {
    ...
    document.getElementsByClassName("number_control")[0].innerHTML =
      currentPosition + 1 + " / " + pictures.length;
  };

  return (
    <div className="carousel">
      <div className={showControls ? "carousel__ctrl" : "carousel__ctrl--none"}>
        <img
          src={chevron}
          alt="previous"
      ...
      <span
        className={
          "number_control " +
          (showControls
            ? "carousel__img__number"
            : "carousel__img__number--none")
        }
      >
